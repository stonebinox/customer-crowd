        ...
        $("#popup").html(`
                <div id="snackbar">
                        <div style="">
                                ...
                                <small>powered by <a href="http://customercrowd.com" target="_blank" style="color: #51bcda !important; margin-top: -10px;"><strong>CustomerCrowd</strong></a></small><small class="dismiss" id="dismiss" style="display: none;"><a style="text-decoration: none;" href="#" onclick="dismiss()">Dismiss</a></small>
                        </div>
                </div>
        ` );
        //end do something
